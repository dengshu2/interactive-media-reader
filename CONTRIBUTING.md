...
1. Keep the product boundary intact: one local English-language media input, no multilingual handling, translation, or manuscript alignment.
...
4. Do not commit media, model files, transcripts, generated readers, virtual environments, or cache contents.
